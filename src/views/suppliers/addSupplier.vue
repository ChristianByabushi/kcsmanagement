            ...
            <v-row>
              ...
              <v-col cols="6">
                <v-text-field
                  ...
                  v-model="phoneNumber"
                  label="phoneNumber"
                  hint="Tap the number of the supplier here! ( put - if no one)"
                  persistent-hint
                  required
                  :rules="[rules.required]"
                  clearable
...
export default {
  ...
  methods: {
    ...
    async postForAddingSupplier() {
      this.loadingButton = true;
      this.errors = [];
      await axios
        .post("kcs/api/suppliers/", {
          name: this.name,
