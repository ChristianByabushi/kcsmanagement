        ...
        <v-card>
          <v-toolbar color="primaryMenu" dark flat>
            ...
            <template v-slot:extension>
              ...
              >
                <v-tabs-slider
                  color="$vuetify.theme.dark ? 'primaryMenu' : 'white'"
                ></v-tabs-slider>
...
import Purchase from "@/views/purchases/index.vue";
export default {
  name: "Home",
  data: () => ({
    latestProducts: [],
    ...
    dialog: false,
    tab: null,
    items: ["Categories", "Produits", "Fournisseurs", "Tendances"],
    text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
  }),
  components: { ProductBox, Categorie, Purchase },

  mounted() {
    // this.getLastestProducts();
    document.title = "Home" + "| KCS";
  },
